...
export default function Navbar() {
  return (
    <nav className='border-b w-full h-16 border-white/10 bg-black/60 backdrop-blur-xl items-center flex px-7 justify-between'>
        <div className='flex justify-center items-center gap-2'>
            <Image src="/logo.png" alt="logo" width={30} height={30}/>
            <Link href={'/'} className='text-lg font-bold'>Safe Report</Link>
        </div>
